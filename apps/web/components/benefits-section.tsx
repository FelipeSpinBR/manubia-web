  ...
  return (
    <section className="section-space bg-white">
      <div className="container-site grid gap-10 lg:grid-cols-2">
        <div className="card-soft min-h-[340px] bg-gradient-to-br from-amber-50 to-blue-50 p-6" />

        <div>
          <h2 className="text-3xl font-bold text-slate-900">Mais clareza para a vida financeira da sua família</h2>
          <div className="mt-8 space-y-6">
            {benefits.map((benefit) => (
              <article key={benefit.title} className="flex gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-5">
